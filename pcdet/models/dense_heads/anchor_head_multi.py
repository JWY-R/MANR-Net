    ...
    def get_box_reg_layer_loss(self):
        ...
        for idx, box_pred in enumerate(box_preds):
            ...
            if box_dir_cls_preds is not None:
                ...
                loc_loss_src = self.reg_loss_func(box_pred_sin, reg_target_sin, weights=reg_weight)
            else:
                loc_loss_src = self.reg_loss_func(box_pred, box_reg_target, weights=reg_weight)
